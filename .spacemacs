...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(
     ...
     version-control
     treemacs
     ;; added for support of c++ mode (Wed  7 Jun 10:04:48 CEST 2023)
     (c-c++ :variables
